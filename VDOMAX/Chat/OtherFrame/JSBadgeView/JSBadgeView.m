...
#define kDefaultBadgeTextFont [UIFont boldSystemFontOfSize:17.0]
...
#define kBadgeHeight 22.0f
#define kBadgeTextSideMargin 13.0f

#define kBadgeCornerRadius 20.0f
...
- (void)setParentView:(UIView *)parentView alignment:(JSBadgeViewAlignment)alignment
{
...
{    
    ...
    switch (self.badgeAlignment) {
        ...
        case JSBadgeViewAlignmentTopRight:
            ...
            newFrame.origin.y = -viewHeight / 2.0f;
            break;
        case JSBadgeViewAlignmentTopRight2:
