...
@protocol AKSVideoAndImagePickerDelegate <NSObject>

-(void)AKSVideoAndImagePickerDidCancel;

@end

@interface AKSVideoAndImagePicker : NSObject <UIImagePickerControllerDelegate,UINavigationControllerDelegate> {
	UIImagePickerController *imagePickerController;
	NSString *lastVideoPath;
}
@property (assign, nonatomic) id<AKSVideoAndImagePickerDelegate>delegate;
