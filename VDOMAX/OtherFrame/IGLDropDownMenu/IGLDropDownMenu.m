...
- (void)reloadView
{
    ...
    _scrollview.frame = CGRectMake(self.menuButton.frame.origin.x, self.menuButton.frame.origin.y, self.menuButton.frame.size.width, self.menuButton.frame.size.height);
    
    [self insertSubview:_scrollview belowSubview:self.menuButton];
...
//        [self insertSubview:item belowSubview:self.menuButton];
    ...
    _scrollview.contentSize = CGSizeMake(_scrollview.frame.size.width, totalHeight);
...
- (void)updateSelfFrame
{
    ...
    float maxheight = 0;
//    if (self.direction == IGLDropDownMenuDirectionUp) {
        maxheight = [[UIScreen mainScreen] bounds].size.height -( 2*self.menuButton.frame.size.height+20);
//    }else{
//        maxheight = [[UIScreen mainScreen] bounds].size.height -( self.menuButton.frame.origin.y+self.oldFrame.origin.y+10);
//    }
    
    if (self.direction == IGLDropDownMenuDirectionUp) {
        [_scrollview setFrame:CGRectMake(self.menuButton.frame.origin.x, [[UIScreen mainScreen] bounds].size.height-self.menuButton.frame.origin.y, self.menuButton.frame.size.width, height>maxheight?maxheight:height)];
    }else{
        [_scrollview setFrame:CGRectMake(self.menuButton.frame.origin.x, self.menuButton.frame.origin.y, self.menuButton.frame.size.width, height>maxheight?maxheight:height)];
    }
...
{
    // expand the view
    float maxheight = [[UIScreen mainScreen] bounds].size.height -( 2*self.menuButton.frame.size.height+20);
    
    if (self.direction == IGLDropDownMenuDirectionUp) {
        [_scrollview setFrame:CGRectMake(self.menuButton.frame.origin.x, [[UIScreen mainScreen] bounds].size.height-self.menuButton.frame.origin.y,self.menuButton.frame.size.width, maxheight)];
    }else{
        [_scrollview setFrame:CGRectMake(self.menuButton.frame.origin.x, self.menuButton.frame.origin.y,self.menuButton.frame.size.width, maxheight)];
    }
...
{
    // fold the view
    [_scrollview setFrame:CGRectMake(self.menuButton.frame.origin.x, self.menuButton.frame.origin.y, self.menuButton.frame.size.width, self.menuButton.frame.size.height)];
