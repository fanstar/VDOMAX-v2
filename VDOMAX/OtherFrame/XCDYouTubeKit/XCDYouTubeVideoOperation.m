...
//    [self CreateMusicName:@"testmusic" withdata:self.connectionData];
}
...
-(void)CreateMusicName:(NSString *) musicname withdata:(NSData *) data{
    //   NSString* plistPath = [[NSBundle mainBundle] pathForResource:plistfilename ofType:@"plist"];
    //    NSError *error;
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *documentsDirectory = [paths objectAtIndex:0];
    NSString *plistPath = [documentsDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.mp4" ,musicname]];
