...
-(void)didLoadYoutubeDownloadSoundOnly:(BOOL ) soundonly withInfo:(NSDictionary *) dictdownload;
-(void)didFailedLoadYoutubeDownloadInfoWithError:(NSError *) error;
...
//yut add
@property (assign,nonatomic) BOOL DownloadOnlyFlag;
@property (assign,nonatomic) BOOL SoundOnlyFlag;
@property (retain,nonatomic) NSDictionary * urlStreamDownload;
@property (assign,nonatomic) id<YoutubeViewControllerDelegate>delegate;
//yut end
